...
import 'package:mechanics_dashbord/screens/loading_manager.dart';
import 'package:mechanics_dashbord/services/global_method.dart';
import 'package:mechanics_dashbord/services/utils.dart';
import 'package:mechanics_dashbord/widgets/buttons.dart';
    ...
    if (isValid) {
      ...
      try {
        ...
        await FirebaseFirestore.instance
          ...
          'imageUrl':
              _pickedImage == null ? widget.imageUrl : imageUrl,
    ...
    return DropdownButtonHideUnderline(
      child: DropdownButton<String>(
        ...
        items: const [
          DropdownMenuItem<String>(
            value: 'Car_Lantern',
            child: Text('Car_Lantern'),
          ),
          DropdownMenuItem<String>(
            value: 'Motor Oil',
            child: Text('Motor Oil'),
          ),
          DropdownMenuItem<String>(
            value: 'Tires',
            child: Text('Tires'),
